from .junheon_mobile_controller_wrapper_cpp import MecanumWheel as MecanumWheelcpp
import numpy as np
...
class MecanumWheel:
    """
    MecanumWheel class for controlling a mecanum-wheel-based mobile robot.
    ...
    def __init__(self, wheel_names, base_width, base_length, wheel_radius, lin_vel_limit, ang_vel_limit, lin_acc_limit, ang_acc_limit, control_freq):
        ...
        self.controller = MecanumWheelcpp(self.wheel_names,
                                          self.base_width,
                                          self.base_length,
                                          self.wheel_radius,
                                          self.lin_vel_limit,
